            ...
            <div class="bg-white shadow-xl sm:rounded-lg p-6">
                ...
                <form id="transaction-form" action="" method="GET">
                            ...
                            <div class="flex flex-col space-y-4">
                                ...
                                <div>
                                    ...
                                    <input id="date_paid" name="date_paid" type="date"
                                        ...
                                        value="{{ old('date_paid', $transaction->date_paid) }}" readonly>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="details-container" class="p-4">
                        <div class="mb-4 p-4 border border-gray-300 rounded-lg bg-gray-50 shadow-sm">
                            ...
                            <button id="addGroupButton"
                                class="bg-green-500 text-white px-4 py-2 mt-4 rounded-md shadow-md hover:bg-green-600 transition-all">Tambah
                                Kelompok</button>
                    ...
                    <div class="mt-6 flex justify-end">
                        <a href="{{ route('transactions.index') }}"
                            class="bg-gray-600 text-white px-4 py-2 rounded-md">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const createTransactionGroup = (detail = null) => {
                ...
                categorySelect.classList.add('form-select', 'rounded-md', 'shadow-sm', 'p-2', 'border',
                    'border-gray-300', 'w-full', 'readonly');
            ...
            const addRowToTable = (tbody, index, detail = null) => {
                ...
                <td class="border-t p-4">
                    <input type="text" name="details[${index}][name]" class="form-input rounded-md shadow-sm col-span-2 border border-gray-300 w-full" placeholder="Contoh: Mobil Agustus" value="${detail ? detail.name : ''}" readonly>
                </td>
                <td class="border-t p-2">
                    <input type="number" name="details[${index}][amount]" class="form-input amount-input rounded-md shadow-sm col-span-1 border border-gray-300 w-full" placeholder="800.000" value="${detail ? detail.value_idr : ''}" readonly>
                </td>
                <td class="border-t p-2">
